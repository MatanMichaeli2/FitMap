// src/components/tests/ChallengeDetail.test.js
...
describe('ChallengeCard Component', () => {
  ...
  test('displays progress bar when user is participating', async () => {
    ...
    // Look for progress percentage in the document with waitFor
    await waitFor(() => {
  ...
  test('shows completed by user status when user has met target', async () => {
    ...
    // Look for 100% progress with waitFor to handle async animation
    await waitFor(() => {
